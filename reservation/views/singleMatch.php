		...
		<div data-role="page" id="singleMatch">
			...
			<div data-role="content">
				...
				<form id="singleMatch" name="bookingForm" action="?cmd=calendar" method="post" data-ajax="false">
					...
					<div id="saveSubmit">
						<input type="submit" id="saveBooking" name="saveBooking" value="Reservation speichern" class="okButton" data-icon="check" data-iconpos="top" onsubmit="return validateSingleForm()">
					</div>
					<div id="cancel">
